...
class _FeedBoxState extends State<FeedBox> {
  ...
  Widget _buildBody(BuildContext context, DocumentSnapshot snapshot) {
    ...
    var runes = trimmedContent.runes;
    if (runes.length > 50) {
      firstHalf = String.fromCharCodes(runes, 0, 50);
      secondHalf = String.fromCharCodes(runes, 50, runes.length);
    } else {
